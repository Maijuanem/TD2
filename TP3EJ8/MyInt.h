...
#define SET_INT4_FALLING EICRB|=(1<<ISC41);EICRB&=~(1<<ISC40)
#define SET_INT4_RISING EICRB|=(1<<ISC41)|(1<<ISC40)
#define SET_INT4_ANY_CHANGE EICRB|=(1<<ISC40);EICRB&=~(1<<ISC41)
#define SET_INT4_LOW_LEVEL EICRB&=~(1<<ISC41);EICRB&=~(1<<ISC40)
